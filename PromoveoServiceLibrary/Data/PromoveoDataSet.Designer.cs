...
namespace PromoveoServiceLibrary.Data {
...
namespace PromoveoServiceLibrary.Data.PromoveoDataSetTableAdapters {
    ...
    public partial class ConfigurationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Configuration] WHERE (([Id] = @Original_Id) AND ([Name] = @Ori" +
                "ginal_Name) AND ((@IsNull_VisioMasterFilename = 1 AND [VisioMasterFilename] IS N" +
                "ULL) OR ([VisioMasterFilename] = @Original_VisioMasterFilename)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Configuration] ([Name], [VisioMasterFilename]) VALUES (@Name, " +
                "@VisioMasterFilename);\r\nSELECT Id, Name, VisioMasterFilename FROM Configuration " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Configuration] SET [Name] = @Name, [VisioMasterFilename] = @VisioMasterFilename WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_VisioMasterFilename = 1 AND [VisioMasterFilename] IS NULL) OR ([VisioMasterFilename] = @Original_VisioMasterFilename)));
SELECT Id, Name, VisioMasterFilename FROM Configuration WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PromoveoServiceLibrary.Properties.Settings.Default.PromoveoDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, VisioMasterFilename FROM dbo.Configuration";
